...
time=c('11:40','11:50','12:00','12:12','12:22','12:32','12:43','12:52')
meatTemp=c(59,81,117,140,151,156,162,163)
airTemp=c(201,212,210,217,221,223,226,230)
# 12:23 - reduced venting slightly
...
ggplot(df,aes(hm,temp,color=source)) + 
  ...
  ylab('Temperature') +
  xlab('Time') +
  geom_vline(xintercept = as.POSIXct(strptime('12:23', '%H:%M',tz='GMT')) ,linetype='dashed',size=0.5,color='red')
